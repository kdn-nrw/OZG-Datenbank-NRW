...
/**
 * Functional test for the controllers defined inside ImplementationProject.
 */
class ImplementationProjectAdminTest extends AbstractBackendAdminControllerTestCase
{
