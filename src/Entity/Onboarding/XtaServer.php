 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="ozg_onboarding_xta_server")
 */
class XtaServer extends AbstractOnboardingEntity
{
    ...
    public const REQUIRED_COMMUNE_BUREAU_ID = 49;
    ...
    public static $applicationTypeChoices = [
        'app.xta_server.entity.application_type_choices.new' => self::APPLICATION_TYPE_NEW,
        'app.xta_server.entity.application_type_choices.update' => self::APPLICATION_TYPE_UPDATE,
    ];
    /**
     * @var array intermediary operator type choices
     */
    public static $intermediaryOperatorTypeChoices = [
        'app.xta_server.entity.intermediary_operator_type_choices.1' => self::INTERMEDIARY_OPERATOR_TYPE_1,
        'app.xta_server.entity.intermediary_operator_type_choices.2' => self::INTERMEDIARY_OPERATOR_TYPE_2,
        'app.xta_server.entity.intermediary_operator_type_choices.9' => self::INTERMEDIARY_OPERATOR_TYPE_UNKNOWN,
    ];
