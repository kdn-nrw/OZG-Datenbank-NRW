...
class MonumentAuthorityAdmin extends AbstractOnboardingAdmin implements AuditedEntityAdminInterface
{
    ...
    protected function configureFormGroups(FormMapper $form)
    {
        $form
            ->with('general', [
                'label' => 'app.monument_authority.groups.general',
                'description' => 'app.monument_authority.groups.general_description',
                'class' => 'col-md-12',
            ])
            ->end();
    }
    ...
    protected function configureFormFields(FormMapper $form): void
    {
        ...
        $form
            ->add('applicationType', ChoiceType::class, [
                ...
                'choices' => MonumentAuthority::$applicationTypeChoices,
        ...
        /** @var MonumentAuthority|null $subject */
        $subject = $this->getSubject();
        if ($subject instanceof MonumentAuthority && null !== $communeType = $subject->getCommuneType()) {
            $form
                ->add('communeTypeName', TextType::class, [
                    'label' => 'app.monument_authority.entity.commune_type',
                    'required' => false,
                    'disabled' => true,
                    'mapped' => false,
                    'data' => $communeType . ''
        ...
        $form
            ->add('intermediaryOperatorType', ChoiceType::class, [
                ...
                'choices' => MonumentAuthority::$intermediaryOperatorTypeChoices,
                'required' => $enableRequiredFields,
                'expanded' => true,
                'placeholder' => false,
                'choice_attr' => static function ($choice, $key, $value) {
    ...
    protected function addContactFormFields(FormMapper $form)
    {
        $form
            ->with('contact_data', [
                'label' => 'app.monument_authority.groups.contact_data',
    ...
    protected function addDocumentFormFields(FormMapper $form, bool $enableRequiredFields)
    {
        $form->with('group_documents', [
            'label' => 'app.monument_authority.groups.documents',
            'class' => 'col-xs-12 col-md-6',
        ]);
    ...
    public function validate(ErrorElement $errorElement, $object)
    {
        $errorElement
            ...
            ->addConstraint(new Regex([
                'pattern' => "/^bab\:[\d]{5,8}/",
                'message' => $this->trans('app.monument_authority.entity.organizational_key_validation_error'),
            ]))
            ->end();
        $errorElement
            ->with('documents')
