...
/**
 * Frontend route generator
 */
class FrontendRouteGenerator implements RouteGeneratorInterface
{
    ...
    {
        if ($admin instanceof AbstractFrontendAdmin && in_array($name, ['show', 'list', 'export'], false)) {
            $route = $admin->getRoutePrefix() . '_' . $name;
