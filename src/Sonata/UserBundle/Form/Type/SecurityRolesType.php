...
namespace App\Sonata\UserBundle\Form\Type;

use App\Sonata\UserBundle\Form\Transformer\RestoreRolesTransformer;
use App\Sonata\UserBundle\Security\EditableRolesBuilder;
