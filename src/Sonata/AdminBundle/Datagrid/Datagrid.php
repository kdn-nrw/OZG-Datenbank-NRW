...
/*
 * This file is a copy of \Sonata\AdminBundle\Datagrid\Datagrid and just removes the "final" declaration
 * and makes some properties protected. Unfortunately Sonata made everything final and somewhat non-extendable.
 *
...
namespace App\Sonata\AdminBundle\Datagrid;
...
class Datagrid implements DatagridInterface
{
    ...
    {
        foreach ($this->filters as $filter) {
            $showFilter = $filter->getOption('show_filter');
