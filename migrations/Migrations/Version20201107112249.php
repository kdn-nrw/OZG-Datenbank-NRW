...
final class Version20201107112249 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO ozg_api_consumer (id, description, proxy, consumer_key, modified_at, created_at, name, hidden, url) VALUES (1, \'Mithilfe der ARS/AGS-API v1.0 können amtlicher Gemeindeschlüssel (AGS) und amtlicher Regionalschlüssel (ARS) von Orten oder Gebieten ermittelt werden.\', null, \'ars_ags\', NOW(), NOW(), \'ARS/AGS-API v1.0\', 0, \'https://ags-ars.api.vsm.nrw/orte\')');
        $this->addSql('INSERT INTO ozg_api_consumer (id, description, proxy, consumer_key, modified_at, created_at, name, hidden, url) VALUES (2, \'Die LeiKa API v1.0 liefert zu einem eingegebenen Leistungsbegriff relevante Informationen zurück.\', null, \'leika\', NOW(), NOW(), \'LeiKa-API v1.0\', 0, \'https://leika.vsm.nrw/services\')');
